...
class _plots:
    ...
    def _pie_chart(self, A, indexes, attribute_indexes, archetype_dataframe,  save_fig, filename):
        ...
        if attribute_indexes == []:
            ...
            for pair in attribute_indexes:
                data_subset = archetype_dataframe.loc[archetype_dataframe[pair[0]] == pair[1]]
