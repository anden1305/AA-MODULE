...
class _CAA_result:
    ...
    def _plot(self,plot_type, attributes, archetype_number, types, weighted, subject_indexes, attribute_indexes, archetype_dataframe, save_figure, filename):
        ...
        if plot_type == "PCA_scatter_plot":
            ...
            self.plots._pie_chart(self.A, subject_indexes, attribute_indexes, archetype_dataframe,  save_figure, filename)
